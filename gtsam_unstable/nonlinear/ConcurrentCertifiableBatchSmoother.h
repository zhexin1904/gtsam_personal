...
#ifndef GTSAM_CONCURRENTCERTIFIABLEBATCHSMOOTHER_H
#define GTSAM_CONCURRENTCERTIFIABLEBATCHSMOOTHER_H
 ...
 * A Levenberg-Marquardt Batch Smoother that implements the Concurrent Filtering and Smoother interface.
    */
   class GTSAM_UNSTABLE_EXPORT ConcurrentCertifiableBatchSmoother : public ConcurrentSmoother {

    public:
     typedef std::shared_ptr<ConcurrentCertifiableBatchSmoother> shared_ptr;
     ...
     /** Default constructor */
     ConcurrentCertifiableBatchSmoother(const LevenbergMarquardtParams& parameters = LevenbergMarquardtParams()) : parameters_(parameters) {}

     /** Default destructor */
     ~ConcurrentCertifiableBatchSmoother() override {}
...
//                           const std::optional< std::vector<size_t> >& removeFactorIndices = {});
     /// Templated update() that pins separator keys of type VALUE
   ...
   * */
     ...
     // A templated overload of optimize():
     template<typename VALUE>
     Result optimize();
   ...
   }; // ConcurrentCertifiableBatchSmoother

   /// Typedef for Matlab wrapping
   typedef ConcurrentCertifiableBatchSmoother::Result ConcurrentCertifiableBatchSmootherResult;

   /// traits
   template<>
   struct traits<ConcurrentCertifiableBatchSmoother> : public Testable<ConcurrentCertifiableBatchSmoother> {
   };

 } //\ namespace gtsam


#endif  // GTSAM_CONCURRENTCERTIFIABLEBATCHSMOOTHER_H
